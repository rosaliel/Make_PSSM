...
echo "cd $dir">> $jobname
printf "/home/labs/fleishman/adig/Rosetta/main/source/bin/rosetta_scripts.default.linuxgccrelease" >> $jobname
#printf "/apps/RH6U4/blcr/0.8.5/bin/cr_run /home/labs/fleishman/adig/Rosetta/main/source/bin/rosetta_scripts.default.linuxgccrelease" >> $jobname
#printf "/home/labs/fleishman/gideonla/Rosetta/main/source/bin/rosetta_scripts.default.linuxgccrelease" >> $jobname
#printf "/home/labs/fleishman/sarel/rosetta/main/source/bin/rosetta_scripts.default.linuxgccrelease " >> $jobname
until [ -z $2 ]; do
	printf " $2 "
	shift
done >> $jobname
...
echo "/usr/share/lsf/9.1/linux2.6-glibc2.3-x86_64/bin/bsub -u /dev/null  -R rusage[mem=2048] -L /bin/bash -G fleishman-wx-grp-lsf -q new-all.q -o $out -e $err /apps/RH6U4/blcr/0.8.5/bin/cr_run $jobname" >> $commandname
